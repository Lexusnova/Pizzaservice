...
abstract class Page
{
    ...
    /**
     * This method converts the numerical Order-status to defined String
     * @param int $status
     * @return string order-status e.g. bestellt, im ofen...
     */
    protected function statusToString(int $status): string
    {
        switch($status)
        {
            case 1:
