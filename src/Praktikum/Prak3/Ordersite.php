...
class Ordersite extends Page
{
    ...
    protected function generateView():void
    {
        ...
        $this->generatePageHeader('Ordering');
        $cart = array("Salami", "Spinat-Hühnchen");
        echo <<<HTML
<h1>Bestellung</h1>
...
<section class="warenkorb">
  ...
  <form action="./Ordersite.php" method="POST">
    ...
    <p>14,50€</p>
    <input type="text" name="address" id="address" value="" placeholder="Please input your address.">
    <button tabindex="2" accesskey="a">Alle Löschen (a)</button>
    <button tabindex="3" accesskey="s">Auswahl Löschen (s)</button>
    <button type="submit" tabindex="4" accesskey="b">Bestellen (b)</button>
  </form>
</section>
