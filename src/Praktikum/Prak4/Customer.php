...
class Customer extends Page
{
    ...
    protected function generateView():void
    {
        ...
        $jsonstring = '[{"name":"Vegetaria","status":"0"},{"name":"Vegetaria","status":"0"}]';

            echo <<<HTML
    <script src="update.js" onload='requestData()'></script>
    <div class="container">
        <div id="customerDiv">
        </div>
        <a href="./Ordersite.php" tabindex="1" accesskey="b">Neue Bestellung (b)</a>
    </div>
