...
HTML;
    ...
    <form action="./Baker.php" method="POST" id="form{$pizzaId}">
      ...
      <input type="radio" name="status" id="form{$pizzaId}bestellt" value="1"{$this->statusChecked($pizzaStatus,1)}>
      <input type="radio" name="status" id="form{$pizzaId}imOfen" value="2"{$this->statusChecked($pizzaStatus,2)}>
      <input type="radio" name="status" id="form{$pizzaId}fertig" value="3"{$this->statusChecked($pizzaStatus,3)}>
      <button type="submit" name="action" value="{$pizzaId}" tabindex="1" accesskey="s">Submit (s)</button>
    </form>
