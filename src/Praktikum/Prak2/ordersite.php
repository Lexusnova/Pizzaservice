...
class Order extends Page
{
    ...
    protected function generatePageHeader(string $title = "Order", string $jsFile = "", bool $autoreload = false): void
    {
    ...
    protected function getViewData():array
    {
        ...
        if ($result = $this->_database->query("SELECT * FROM article LIMIT 10")) {
            $i = 0;
    ...
    protected function generateView():void
    {
        ...
        {
            $key_num = $num+1;
            $picture = "picture$key_num";
            $pictureName = $pizzas->picture;
            echo <<<END
            <fieldset>
            <legend accesskey="$key_num"><img src="$pictureName" alt="" width="150" >
            <legend accesskey="$key_num">$pizzas->name<b></b></legend>
            <legend accesskey="$key_num">$pizzas->price €<b></b></legend>
              </fieldset>
